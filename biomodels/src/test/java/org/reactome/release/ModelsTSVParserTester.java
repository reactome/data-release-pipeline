...
public class ModelsTSVParserTester {
    ...
    public void emptyFilenameReturnsEmptyMap() {
        ...
        assertThat("Empty file produces empty pathwayToBioModelsIds map", pathwayToBioModelsIds, is(anEmptyMap()));
    }
    ...
    public void unknownFileNameReturnsEmptyMap() {
        ...
        assertThat("Unknown file produces empty pathwayToBioModelsIds map", pathwayToBioModelsIds, is(anEmptyMap()));
    }
    ...
    public void improperlyFormattedFileReturnsEmptyMap() {
        ...
        assertThat("Improperly formatted file produces empty pathwayToBioModelsIds map", pathwayToBioModelsIds, is(anEmptyMap()));
    }
    ...
    public void partiallyCorrectFileReturnsPopulatedMap() {
        ...
        assertThat(pathwayToBioModelsIds.get("R-MMU-1169091"), contains("BIOMD0000000226"));
    }
    ...
    public void testFileProducesMappingWithoutNullKeysOrValues() {
        ...
        assertThat("pathwayToBioModelsIds map does not contain any null keys", pathwayToBioModelsIds, not(hasKey(nullValue())));
        assertThat("pathwayToBioModelsIds map does not contain any null values", pathwayToBioModelsIds, not(hasValue(nullValue())));
    }
