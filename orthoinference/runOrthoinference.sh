...
do
	echo "java -jar target/orthoinference-1.0.1-jar-with-dependencies.jar $species > orthoinference_$species.out";
	java -jar target/orthoinference-1.0.1-jar-with-dependencies.jar $species > orthoinference_$species.out;
done
