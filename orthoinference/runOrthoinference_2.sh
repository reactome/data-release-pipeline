...
mysqldump --defaults-file=.my_ortho.cnf -h localhost test_slice_oryza_sativa_19_ortho_osat_all > ./mysql_ortho_dumps/test_slice_oryza_sativa_19_ortho_osat_all_new_compara.sql
