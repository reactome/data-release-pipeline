...
public class KEGGAddLinksMycobacteriumH37RvLinkFix {
    public static void main(String[] args) throws Exception {
        ...
        //TODO: Should display name be updated? Technically the identifier includes the prefix, but from Reactome's perspective we've never included the prefix.
        //TODO: Add instanceEdit for these changes.
